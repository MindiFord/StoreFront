...
namespace StoreFront.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,CategoryID,Image,ProductDesc,UnitPrice,PriceID,StatusID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,CategoryID,Image,ProductDesc,UnitPrice,PriceID,StatusID")] Product product)
        {
            if (ModelState.IsValid)
            {
